$(function(){
    ...
    if (tbClientes == null) //caso não exista conteúdo, iniciamos um vetor vazio;
        ...
        function adicionar(){
            var cli = GetClitente("Codigo", $("txtCodigo").val());
            if (cli != null){ //Verifica se o código já está cadastrado;
        ...
        function Excluir(){
            ...
            tbClientes.splice(indice_selecionado, 1); // O método slice() altera o conteúdo de uma lista, adicionando novos elementos enquanto remove elementos  antigos.
            localStorage.setItem("tbClientes", JSON.stringify(tbClientes));
